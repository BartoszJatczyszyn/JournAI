...
class LLMService:
    """Simple client for a local llama.cpp server (OpenAI-compatible API).

    Environment variables:
    - LLM_BASE_URL: Base URL for the server (default: http://llm:8080/v1 inside Docker; http://localhost:8080/v1 locally)
    - LLM_MODEL: Optional model identifier to include in requests
    - LLM_HTTP_TIMEOUT: Request timeout seconds (default 60)
    """
