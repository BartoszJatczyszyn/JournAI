    ...
    <div className="page-container fade-in">
      ...
      <div className="overview-metrics mb-8">
        <MetricCard
          ...
          icon="📏"
          color="indigo"
          subtitle={activity.duration_min != null ? `${formatDuration(activity.duration_min, 'minutes')} total` : ''}
        />
        <MetricCard
          title="Duration"
          value={activity.duration_min != null ? formatDuration(activity.duration_min, 'minutes') : '—'}
          unit={activity.duration_min != null ? '' : ''}
          icon="⏱️"
          color="green"
          ...
          <div className="card md:col-span-1">
            ...
            <div className="card-content">
              <ul className="space-y-2 text-sm">
                ...
                <li><strong>Duration:</strong> {activity.duration_min != null ? formatDuration(activity.duration_min, 'minutes') : '-'}</li>
